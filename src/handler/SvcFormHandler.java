...
public class SvcFormHandler {
	...
	public ModelAndView svcTripWriteFormProcess(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		//String user_id=(String)request.getSession().getAttribute("user_id");//�굹以묒뿉 二쇱꽍 吏��슦湲�
		String user_id="aaa";
		String user_name= userDao.getUserName(user_id);//user_id 占쌨아쇽옙 db占쏙옙 占쌍댐옙 name 占쏙옙占쏙옙 占쌀뤄옙占쏙옙占쏙옙
