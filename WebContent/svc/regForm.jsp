		...
		<div class="text-center">
		 ...
		 <form class="form-horizontal" method="post"  action="userInputPro.go" name="inputform" onsubmit="return inputcheck()">
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<button type="button" class="btn btn-md btn-secondary" onclick="overlapCheck()">${btn_confirm}</button>			
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="password" class="form-control" id="userPassword1"
						name="passwd" placeholder="비밀번호" maxlength="30" required onkeyup="passwordCheckFunction()">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="user_name" class="form-control" id="name_val" 
						placeholder="Nickname" required>
						<h4 style="color: red;" id="passwordCheckMessageggg"></h4>					
				</div>
				<div class="col-sm-2">
					<button type="button" class="btn btn-md btn-secondary" onclick="over()">${btn_confirm}</button>			
				</div>
			</div>
