  ...
  <body>
	<div class="container" style="width:600px">
		<div class="text-center">
		 ...
		 <form class="form-horizontal" method="post" action="loginPro.go" name="loginform" onsubmit="">
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="user_id" class="form-control" id="inputID" 
						placeholder="${str_id}" maxlength="20" required autofocus>					
				</div>
				<div class="col-sm-2">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="password" name="passwd" class="form-control" id="inputPassword"
						placeholder="${str_passwd}" maxlength="30" required>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="password" class="form-control" id="inputRepassword"
						placeholder="${str_repasswd}" maxlength="30" required>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="user_name" class="form-control" id="inputNickname" 
						placeholder="${str_nickname}" required>					
				</div>
				<div class="col-sm-2">
